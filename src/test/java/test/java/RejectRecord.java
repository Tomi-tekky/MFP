...
public class RejectRecord {
    ...
    @Test(priority = 8)
    void rejectRecord() throws InterruptedException {

        driver.findElement(By.xpath("//span[text()='Record']")).click();
        Thread.sleep(Long.parseLong("2000"));
        driver.findElement(By.xpath("//i[@class='dropdown-toggle pi pi-ellipsis-h']")).click();
        Thread.sleep(Long.parseLong("2000"));
        driver.findElement(By.xpath("//a[text()='Approve/Reject Record']")).click();
        Thread.sleep(Long.parseLong("2000"));

        JavascriptExecutor j = (JavascriptExecutor) driver;
        WebElement submit = driver.findElement(By.xpath("//button[@label='Reject']"));
        j.executeScript("arguments[0].scrollIntoView();",submit);
        Thread.sleep(Long.parseLong("2000"));
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//button[@label='Reject']")))).click();
        Thread.sleep(Long.parseLong("2000"));
        driver.findElement(By.id("comment")).sendKeys("ok");
        Thread.sleep(2000);
