...
public class SendEmail {
    ...
    @Test(priority = 10)
    void SendEmailToUsers() throws InterruptedException, IOException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//button[text()=' Send Email To Users ']")).click();
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//textarea[@formcontrolname='emailSubject']")).sendKeys("Test");
        Thread.sleep(1000);
        driver.findElement(By.xpath("//textarea[@formcontrolname='emailContent']")).sendKeys("ok");
        Thread.sleep(2000);
