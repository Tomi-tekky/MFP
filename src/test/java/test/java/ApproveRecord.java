...
public class ApproveRecord {
    ...
    @Test(priority = 6)
    void approveRecord() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//button[@class='p-element send-button p-button p-component']/span[text()='Accept']")))).click();
        Thread.sleep(Long.parseLong("3000"));
    }
}
